export function BarraPagamentos() {
  return (
    <section className="border-t border-black/5 bg-[#f6f1e7] px-4 py-8">
      <div className="editorial-shell flex flex-col items-start justify-between gap-8 lg:flex-row lg:items-center">
        <div className="flex flex-col gap-3">
          <p className="font-sans text-[11px] font-semibold uppercase tracking-[0.22em] text-nervura-texto-secundario">
            Pagamento seguro
          </p>
          <div className="flex flex-wrap items-center gap-2">
            <div className="flex h-8 w-14 items-center justify-center border border-nervura-verde/10 bg-white px-2 py-1">
            ...
            <div className="flex h-8 w-16 items-center justify-center border border-nervura-verde/10 bg-white px-2 py-1">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-2 border border-nervura-verde/10 bg-white px-4 py-3">
